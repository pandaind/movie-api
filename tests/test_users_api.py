...
async def test_register_user(mocker):
    mock_user_service = mocker.patch("app.services.user_services.UserService.add_user", new_callable=AsyncMock)
    mock_user_service.return_value = UserCreateResponse(username="testuser", email="test@example.com")
