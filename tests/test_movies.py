...
class TestMoviesAPI(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_get_movies(self, mock_get_all_movies, decode_access_token):
    ...
    async def test_get_movie(self, mock_get_movie_by_id, decode_access_token):
        response = await self.client.get(
    ...
    async def test_get_movies_by_genre(
        self, mock_get_movies_by_genre, decode_access_token
    ):
        response = await self.client.get(
    ...
    async def test_update_movie(self, mock_update_movie, decode_access_token):
    ...
    async def test_delete_movie(self, mock_delete_movie, decode_access_token):
